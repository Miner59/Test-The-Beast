...
minetest.register_craft( {
        output = "homedecor:glass_table_small_round_b 4",
        recipe = {
                { "", "default:glass", "" },
...
minetest.register_craft( {
        output = "homedecor:wood_table_small_round_b 4",
        recipe = {
                { "", "group:wood", "" },
...
minetest.register_craft( {
        output = "homedecor:utility_table_top 3",
        recipe = { 
                { "group:wood", "group:wood", "group:wood" },
		{ "", "homedecor:utility_table_legs","" }
	},
	replacements = { {"homedecor:utility_table_legs", "homedecor:utility_table_legs"}, },
})
--
...
minetest.register_craft({
        type = "fuel",
        recipe = "homedecor:utility_table_top",
        burntime = 10,
})
