...
minetest.register_node("homedecor:pole_steel", {
        description = S("Steel Pole"),
        drawtype = "nodebox",
        tiles = {"homedecor_tile_steel.png"},
        inventory_image = "homedecor_pole_steel.png",
        wield_image = "homedecor_pole_steel.png",
        paramtype = "light",
        is_ground_content = true,
        selection_box = {
                type = "fixed",
