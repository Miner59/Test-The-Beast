...
function technic.register_battery_box(data)
	...
	local formspec =
		...
		"image[1,2;1,2;technic_power_meter_bg.png]"..
		"list[current_name;src;3,2;1,1;]"..
		"image[4,2;1,1;technic_battery_reload.png]"..
		"list[current_name;dst;5,2;1,1;]"..
		"label[0,1;"..S("%s Battery Box"):format(tier).."]"..
		"label[3,1;"..S("Charge").."]"..
		"label[5,1;"..S("Discharge").."]"..
		"label[1,4;"..S("Power level").."]"..
