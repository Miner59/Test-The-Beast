...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if water_nodes == 1 and lava_nodes == 1 then production_level =  25; eu_supply = 1 end
		if water_nodes == 2 and lava_nodes == 1 then production_level =  50; eu_supply = 2 end
		if water_nodes == 1 and lava_nodes == 2 then production_level =  75; eu_supply = 3 end
		if water_nodes == 2 and lava_nodes == 2 then production_level = 100; eu_supply = 4 end
...
eu_supply=math.floor(eu_supply*20+mp*eu_supply)
