...
technic.register_extractor_recipe("technic:coal_dust",        1,          "dye:black",      4)
technic.register_extractor_recipe("default:cactus",           1,          "dye:green",      4)
technic.register_extractor_recipe("default:dry_shrub",        1,          "dye:brown",      4)
technic.register_extractor_recipe("flowers:geranium",         1,          "dye:blue",       4)
technic.register_extractor_recipe("flowers:dandelion_white",  1,          "dye:white",      4)
technic.register_extractor_recipe("flowers:dandelion_yellow", 1,          "dye:yellow",     4)
technic.register_extractor_recipe("flowers:tulip",            1,          "dye:orange",     4)
technic.register_extractor_recipe("flowers:rose",             1,          "dye:red",        4)
technic.register_extractor_recipe("flowers:viola",            1,          "dye:violet",     4)
technic.register_extractor_recipe("flowers:cornflower",            1,          "dye:cyan",     4)
technic.register_extractor_recipe("flowers:malva",            1,          "dye:pink",     4)
technic.register_extractor_recipe("flowers:silver_thistle",            1,          "dye:grey",     4)
...
technic.register_extractor_recipe("moretrees:rubber_tree_trunk",       1, "technic:rubber", 3)
technic.register_extractor_recipe("technic:uranium",          2,          "technic:enriched_uranium", 1)
...
local extractor_formspec =
   ...
   "label[0,0;"..S("Extractor").."]"..
							 "button_exit[1,1;1,0.8;button1;ESC]"..
   "list[current_name;src;3,2;1,1;]"..
   "list[current_name;dst;5,2;2,2;]"..
   "list[current_player;main;0,6;8,4;]"

minetest.register_node("technic:extractor", {
	description = S("Extractor"),
	tiles = {"technic_hv_grinder_top.png",  "technic_hv_grinder_bottom.png", "technic_hv_grinder_side.png",
	         "technic_hv_grinder_side.png", "technic_hv_grinder_side.png",   "technic_hv_grinder_front.png"},
	paramtype2 = "facedir",
	groups = {cracky=2},
...
minetest.register_node("technic:extractor_active", {
	description = S("Extractor"),
	tiles = {"technic_hv_grinder_top.png",  "technic_hv_grinder_bottom.png", "technic_hv_grinder_side.png",
	         "technic_hv_grinder_side.png", "technic_hv_grinder_side.png",   "technic_hv_grinder_front_active.png"},
	paramtype2 = "facedir",
