...
technic.register_compressor_recipe("default:sand",              2, "default:sandstone",       1)
technic.register_compressor_recipe("default:desert_sand",       1, "default:desert_stone",    1)
technic.register_compressor_recipe("default:sandstone",         1, "technic:marble",          1)
technic.register_compressor_recipe("moreblocks:iron_stone",      1, "technic:granite",         1)
technic.register_compressor_recipe("technic:enriched_uranium",  2, "technic:uranium_fuel",    1)
technic.register_compressor_recipe("vessels:steel_bottle",         1, "technic:gas_cylinder",             1)
