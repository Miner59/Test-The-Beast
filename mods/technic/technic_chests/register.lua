...
local function set_formspec(pos, data, page)
	...
	if data.infotext then
		...
		if page == "main" then
			formspec = formspec.."image_button["..(data.hileft+3.1)..",0.1;0.8,0.8;"
					.."technic_pencil_icon.png;edit_infotext;]"
					.."label["..(data.hileft+4)..",0;"..formspec_infotext.."]"
		elseif page == "edit_infotext" then
			formspec = formspec.."image_button["..(data.hileft+3.1)..",0.1;0.8,0.8;"
					.."technic_checkmark_icon.png;save_infotext;]"
					.."field["..(data.hileft+4.3)..",0.2;4.8,1;"
...
local dfds=		"button_exit[0,0;1,0.8;ex;ESC]"
if lname=="mithril" or lname=="gold" then
dfds=		"button_exit[0,10;1,0.8;ex;ESC]"
end
	data.base_formspec = "invsize["..data.ovwidth..","..data.ovheight..";]"..
			"label[1,0;"..S("%s Chest"):format(name).."]"..
			dfds..
			"list[current_name;main;"..data.hileft..",1;"..data.width..","..data.height..";]"..
			"list[current_player;main;"..data.loleft..","..data.lotop..";8,4;]"

if lname=="mithril" then
	data.base_formspec =	data.base_formspec.."background[-0.19,-0.25;"..(data.ovwidth+0.4)..","..(data.ovheight+0.75)..";ui_form_bg.png]"..
