...
local piston_on = function(pos, node)
	...
	local maxpush = mesecon.setting("piston_max_push", 50)
...
local pistonspec_normal = {
	offname = "mesecons_pistons:piston",
...
-- offstate
minetest.register_node("mesecons_pistons:piston", {
	description = "Piston",
	tiles = {
...
local pistonspec_sticky = {
	...
	dir = piston_facedir_direction,
	pusher = "mesecons_pistons:piston_pusher_sticky_off",
	sticky = true,
...
-- pusher
minetest.register_node("mesecons_pistons:piston_pusher_sticky_off", {
	drawtype = "nodebox",
	tiles = {
		"mesecons_piston_pusher_top.png",
		"mesecons_piston_pusher_bottom.png",
...
local pistonspec_sticky_up = {
	...
	dir = {x = 0, y = 1, z = 0},
	pusher = "mesecons_pistons:piston_up_pusher_sticky_off",
	sticky = true
}
...
-- pusher
minetest.register_node("mesecons_pistons:piston_up_pusher_sticky_off", {
	drawtype = "nodebox",
	tiles = {
		"mesecons_piston_pusher_front_sticky.png",
		"mesecons_piston_pusher_back.png",
...
local pistonspec_sticky_down = {
	...
	dir = {x = 0, y = -1, z = 0},
	pusher = "mesecons_pistons:piston_down_pusher_sticky_off",
	sticky = true
}
...
-- pusher
minetest.register_node("mesecons_pistons:piston_down_pusher_sticky_off", {
	drawtype = "nodebox",
	tiles = {
		"mesecons_piston_pusher_back.png",
		"mesecons_piston_pusher_front_sticky.png",
...
mesecon.register_mvps_stopper("mesecons_pistons:piston_pusher_sticky_off", piston_pusher_get_stopper)

mesecon.register_mvps_stopper("mesecons_pistons:piston_up_pusher_normal", piston_pusher_up_down_get_stopper)
mesecon.register_mvps_stopper("mesecons_pistons:piston_up_pusher_sticky_off", piston_pusher_up_down_get_stopper)

mesecon.register_mvps_stopper("mesecons_pistons:piston_down_pusher_normal", piston_pusher_up_down_get_stopper)
mesecon.register_mvps_stopper("mesecons_pistons:piston_down_pusher_sticky_off", piston_pusher_up_down_get_stopper)
...
minetest.register_craft({
	output = "mesecons_pistons:piston 2",
	recipe = {
