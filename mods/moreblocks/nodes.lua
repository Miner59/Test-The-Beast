...
local nodes = {
	...
	["wood_tile_flipped"] = {
		description = S("Wooden Tile"),
		groups = {snappy = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 3,not_in_craft_guide=1},
	...
	["fast_stone"] = {
		description = S("Fast Stone"),
		paramtype = "light",
		drop='moreblocks:fast_cobble',
		sunlight_propagates = true,
		light_source = 2,
		groups = {cracky = 3, fast = 1},
		tiles = {"default_stone.png"},
		sounds = sound_stone,
	},
	["fast_cobble"] = {
		description = S("Fast Cobble"),
		paramtype = "light",
		sunlight_propagates = true,
		light_source = 2,
		groups = {cracky = 3, fast = 1},
