...
function circular_saw.on_construct(pos)
	local meta = minetest.get_meta(pos)
	meta:set_string("formspec", "size[11,10]" ..gui_slots..
							 "button_exit[0,0;1,0.8;button1;ESC]"..
			"label[0,1;" ..S("Input\nmaterial").. "]" ..
			"list[current_name;input;1.5,0;1,1;]" ..
			"label[0,2;" ..S("Left-over").. "]" ..
			"list[current_name;micro;1.5,1;1,1;]" ..
			"label[0,3;" ..S("Recycle\noutput").. "]" ..
			"list[current_name;recycle;1.5,2;1,1;]" ..
			"field[0.3,4.5;1,1;max_offered;" ..S("Max").. ":;${max_offered}]" ..
			"button[1,4.2;1,1;Set;" ..S("Set").. "]" ..
			"list[current_name;output;2.8,1;8,4;]" ..
