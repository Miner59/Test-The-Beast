...
for i in ipairs(moretrees.treelist) do
	...
	if treename ~= "jungletree" then -- the default game provides jungle tree trunk/planks nodes.
		...
		minetest.register_node("moretrees:"..treename.."_sapling_ongen", {
			...
			groups = {snappy=2,dig_immediate=3,flammable=2,attached_node=1,not_in_creative_inventory=1,not_in_craft_guide=1,sapling=1},
			sounds = default.node_sound_defaults(),
		...
		if minetest.get_modpath("moreblocks") and moretrees.enable_stairsplus then
			...
			register_stair(
				...
				{ snappy=1,choppy=2,oddly_breakable_by_hand=1,flammable=2, not_in_creative_inventory=1, tree_stair=1, not_in_craft_guide=1 },
				{	"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk.png"
				},
			...
			register_slab(
				...
				treename.."_trunk",
				"moretrees:"..treename.."_trunk",
				{ snappy=1,choppy=2,oddly_breakable_by_hand=1,flammable=2, not_in_creative_inventory=1, tree_slab=1 , not_in_craft_guide=1},
				{	"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk.png"
				},
			...
			register_panel(
				...
				treename.."_trunk",
				"moretrees:"..treename.."_trunk",
				{ snappy=1,choppy=2,oddly_breakable_by_hand=1,flammable=2, not_in_creative_inventory=1, tree_panel=1 , not_in_craft_guide=1},
				{	"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk.png"
				},
			...
			register_micro(
				...
				treename.."_trunk",
				"moretrees:"..treename.."_trunk",
				{ snappy=1,choppy=2,oddly_breakable_by_hand=1,flammable=2, not_in_creative_inventory=1, tree_micro=1 , not_in_craft_guide=1},
				{	"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk_top.png",
					"moretrees_"..treename.."_trunk.png"
				},
			...
			register_stair(
				...
				{ snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3, not_in_creative_inventory=1, wood_stair=1 , not_in_craft_guide=1},
			...
			register_slab(
				...
				treename.."_planks",
				"moretrees:"..treename.."_planks",
				{ snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3, not_in_creative_inventory=1, wood_slab=1 , not_in_craft_guide=1},
				{ "moretrees_"..treename.."_wood.png" },
				S(treedesc.." Planks"),
				treename.."_planks",
				0
			...
			register_panel(
				...
				treename.."_planks",
				"moretrees:"..treename.."_planks",
				{ snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3, not_in_creative_inventory=1, wood_panel=1 , not_in_craft_guide=1},
				{ "moretrees_"..treename.."_wood.png" },
				S(treedesc.." Planks"),
				treename.."_planks",
				0
			...
			register_micro(
				...
				treename.."_planks",
				"moretrees:"..treename.."_planks",
				{ snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3, not_in_creative_inventory=1, wood_micro=1 , not_in_craft_guide=1},
				{ "moretrees_"..treename.."_wood.png" },
				S(treedesc.." Planks"),
				treename.."_planks",
				0
...
if treename=="palm" then
table.insert(moretrees.avoidnodes, "default:ice")
table.insert(moretrees.avoidnodes, "paragenv7:permafrost")
table.insert(moretrees.avoidnodes, "default:snowblock")
table.insert(moretrees.avoidnodes, "default:dirt_with_snow")
end
	end
end
