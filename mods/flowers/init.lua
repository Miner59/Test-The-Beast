...
minetest.register_node("flowers:cornflower", {
	description = "Cornflower",
	drawtype = "plantlike",
	tiles = { "flowers_cornflower.png" },
	inventory_image = "flowers_cornflower.png",
	wield_image = "flowers_cornflower.png",
	sunlight_propagates = true,
	paramtype = "light",
	walkable = false,
	buildable_to = true,
	groups = {snappy=3,flammable=2,flower=1,flora=1,attached_node=1,color_cyan=1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
		fixed = { -0.15, -0.5, -0.15, 0.15, 0.2, 0.15 },
...
minetest.register_node("flowers:malva", {
	description = "Malva",
	drawtype = "plantlike",
	tiles = { "flowers_malva.png" },
	inventory_image = "flowers_malva.png",
	wield_image = "flowers_malva.png",
	sunlight_propagates = true,
	paramtype = "light",
	walkable = false,
	buildable_to = true,
...
minetest.register_node("flowers:silver_thistle", {
	description = "Silver Thistle",
	drawtype = "plantlike",
	tiles = { "flowers_silver_thistle.png" },
	inventory_image = "flowers_silver_thistle.png",
	wield_image = "flowers_silver_thistle.png",
	sunlight_propagates = true,
	paramtype = "light",
	walkable = false,
	buildable_to = true,
	...
	action = function(pos, node)
		...
		if #seedling > 0 then
			...
			if minetest.get_node(seedling).name == "air" then
				...
				if nname=="flowers:geranium" then
					local rr=math.random(1999)
					if seedling.y>25 and rr<2 then
						nname="flowers:silver_thistle"
					elseif rr ==4 then
						nname="flowers:malva"
					end
				end
				minetest.set_node(seedling, {name=nname})
			end
		end
	end,
})
