...
dyelocal.dyes = {
	...
	{"dark_grey",  "Dark grey dye", {dye=1, basecolor_darkgrey=1,    excolor_darkgrey=1,  unicolor_darkgrey=1}},
	{"black",      "Black dye",     {dye=1, basecolor_black=1,   excolor_black=1,     unicolor_black=1}},
	{"violet",     "Violet dye",    {dye=1, basecolor_violet=1, excolor_violet=1,    unicolor_violet=1}},
	...
	{"dark_green", "Dark green dye",{dye=1, basecolor_dark_green=1,   excolor_dark_green=1,     unicolor_dark_green=1}},
	...
	{"brown",      "Brown dye",     {dye=1, basecolor_brown=1,  excolor_brown=1,    unicolor_dark_orange=1}},
	...
	{"pink",       "Pink dye",      {dye=1, basecolor_pink=1,     excolor_red=1,       unicolor_light_red=1}},
}
