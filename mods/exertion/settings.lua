...
exertionStatuses = defaults.exertionStatuses or {};
exertionStatuses.light =
   { priority = 1, activityRatio = 0.15, builds = 2 };
exertionStatuses.heavy =
   { priority = 2, activityRatio = 0.75, builds = 10 };
...
foodMultipliers = defaults.foodMultipliers or
   { exertion = {}, fed = {}, hydrated = {}, poisoned = {} };
foodMultipliers.exertion.none  = 0.8;
foodMultipliers.exertion.light = 1.5;
foodMultipliers.exertion.heavy = 2.5;
...
waterMultipliers = defaults.waterMultipliers or
   { exertion = {}, fed = {}, hydrated = {}, poisoned = {} };
waterMultipliers.exertion.none  = 1;
waterMultipliers.exertion.light = 1.2;
waterMultipliers.exertion.heavy = 1.8;
...
jumpMultipliers = defaults.jumpMultipliers or
   { exertion = {}, fed = {}, hydrated = {}, poisoned = {} };
jumpMultipliers.fed.starving        = 1.0;
jumpMultipliers.fed.hungry          = 1.1;
jumpMultipliers.fed.full            = 1.1;
jumpMultipliers.hydrated.dehydrated = 1.0;
jumpMultipliers.hydrated.thirsty    = 1.1;
jumpMultipliers.hydrated.hydrated   = 1.3;
jumpMultipliers.poisoned.none       = 1.0;
jumpMultipliers.poisoned.poisoned   = 0.7;
...
retchProbMultipliers.fed.starving        = 0.4;
retchProbMultipliers.fed.hungry          = 1.0;
retchProbMultipliers.fed.full            = 3.0;
...
fedHud.hud_elem_type = 'statbar';
fedHud.position = { x = 0.0, y = 1.0 };
fedHud.text = "exertion_toastIcon_16x16.png";
fedHud.direction = 3;
fedHud.size = { x = 24, y = 24 };
fedHud.offset = { x = 1, y = -26 };
...
hydratedHud.hud_elem_type = 'statbar';
hydratedHud.position = { x = 0.0, y = 1.0 };
hydratedHud.text = "exertion_waterIcon_16x16.png";
hydratedHud.direction = 3;
hydratedHud.size = { x = 24, y = 24 };
hydratedHud.offset = { x = 20, y = -26 };
...
poisonedHud.hud_elem_type = 'statbar';
poisonedHud.position = { x = 0.0, y = 1.0 };
poisonedHud.text = "exertion_spiderIcon_16x16.png";
poisonedHud.direction = 3;
poisonedHud.size = { x = 24, y = 24 };
poisonedHud.offset = { x = 39, y = -26 };
...
foodPoisoningMessage = "Food poisoning!  Bleh!";
 ...
 -- default: foodPoisoningMessage = "Food poisoning!  Bleh!";
 --
poisoningMessage = "You got poisoned!";
