...
minetest.register_tool("moreores:sword_mithril", {
	...
	tool_capabilities = {
		...
		max_drop_level=1,
		groupcaps={
				fleshy={times={[2]=0.65, [3]=0.25}, uses=250, maxlevel=1},
				snappy={times={[2]=0.70, [3]=0.25}, uses=250, maxlevel=1},
				choppy={times={[3]=0.65}, uses=250, maxlevel=0}
		},
		damage_groups = {fleshy=7},
	}
